...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('social-enable')
    .setDescription('Enable a social account notifier')
  ...
  async execute(interaction) {
    ...
    await prisma.socialAccount.update({ where: { id: account.id }, data: { enabled: true } });
    return interaction.reply({ embeds: [embeds.success(`🟢 **${account.accountName}** (${account.platform}) enabled.`)], ephemeral: true });
  },
};
